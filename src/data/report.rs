...
impl ReportItem {
    pub fn new(diagnostic_type: impl Into<String>, file: impl Into<String>, message: impl Into<String>) -> Self {
        Self {
...
impl Report {
    ...
    pub fn has_errors(&self) -> bool {
        self.items.iter().any(|i| matches!(i.severity, Severity::Error | Severity::Critical))
    }
